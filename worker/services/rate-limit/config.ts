...
export const DEFAULT_RATE_LIMIT_SETTINGS: RateLimitSettings = {
	...
	llmCalls: {
		enabled: false,
		store: RateLimitStore.DURABLE_OBJECT,
		limit: 100000, // raised from 800 (unused when disabled)
		period: 60 * 60, // 1 hour (unused when disabled)
        dailyLimit: 2000000, // raised from 2000 (unused when disabled)
...
export const DEFAULT_RATE_INCREMENTS_FOR_MODELS: Record<AIModels | string, number> = {
    ...
    [AIModels.CF_LLAMA_3_1_8B]: 1,
    [AIModels.CF_LLAMA_3_1_70B]: 4,
    [AIModels.CF_QWEN_2_5_CODER_32B]: 3,
    [AIModels.CF_DEEPSEEK_R1_DISTILL_32B]: 3,
};
