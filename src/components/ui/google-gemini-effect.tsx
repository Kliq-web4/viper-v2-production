...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-80", className)}>
            {title && (
                <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-purple-100 to-purple-400">
                    {title}
                </p>
            )}
            {description && (
                <p className="text-xs md:text-xl font-normal text-center text-purple-400 mt-4 max-w-lg mx-auto">
                    {description}
                </p>
            )}
            <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
                    Powered By IFEANYIGICHI
                </button>
            </div>
            <svg
                width="1440"
